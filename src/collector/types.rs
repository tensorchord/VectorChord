...
pub static mut QUERY_PUSH_MQ: *mut pgrx::pg_sys::shm_mq = ptr::null_mut();
pub static mut QUERY_LOAD_MQ: *mut pgrx::pg_sys::shm_mq = ptr::null_mut();
pub static mut COMMAND_REQUEST: *mut Command = ptr::null_mut();
